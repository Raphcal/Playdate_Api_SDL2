...
typedef enum {
    ...
    SpriteClassNameBonus,
    SpriteClassNameBossSatelliteAux,
    SpriteClassNameBullet,
    SpriteClassNameCameraShake,
    SpriteClassNameCaught,
    SpriteClassNameCloudTransition,
    SpriteClassNameGUILives,
    SpriteClassNameExplosion,
    SpriteClassNameFade,
    SpriteClassNamePlayer,
    SpriteClassNameRocket,
    SpriteClassNameThrown,
} SpriteClassName;
