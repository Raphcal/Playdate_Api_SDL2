...
static const int zIndexDialog = 90;
static const int zIndexDialogButton = 91;
...
LCDSprite * _Nonnull MELDialogMake(MELDialogConfig config) {
    ...
    *self = (MELDialog) {
    ...
    playdate->sprite->setZIndex(sprite, zIndexDialog);
    ...
    if (config.count) {
        ...
        playdate->sprite->setZIndex(gridViewSprite, zIndexDialogButton);
